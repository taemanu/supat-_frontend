  ...
  <main class="content">
      <div class="container-fluid p-0 ">
        <div class="d-flex justify-content-between m-2" >
          <h1 class="h3 mb-4"><strong>ใบเสนอราคา</strong></h1>
            ...
            <table class="table table-bordered mb-0">
              <thead>
                <tr>
                  ...
                  <th class="text-center">ชื่อใบเสนอราคา</th>
              ...
              <tbody>
                <tr v-for="(list, index) in project_store.data_quotation_customer_list" :key="index" >
                    <td class="text-center">{{ list.qt_code }}</td>
                    <td class="text-center">{{ list.qt_name }}</td>
                    ...
                    <td class="text-center">
                      ...
                      <span class="badge bg-warning text-dark" v-if="list.status == 'qt_approve'">รอยืนยันใบเสนอราคา</span>
                    ...
                    <td class="text-center">
                        ...
                        <router-link v-if="list.status != 'pending'" class="btn btn-primary m-1 btn-equal-size" :to="{ path: '/app/Customer/Quotation/Approve', query: { qt_id:list.id } }" >
...
onMounted(async () => {
    await project_store.getDataQuotationCustomerList();
});
