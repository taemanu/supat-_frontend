            ...
            <div class="border border-3 border-dark p-4">
                ...
                <form>
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            <label for="qt_name" class="form-label">ชื่อใบเสนอราคา</label>
                            <input type="text" class="form-control" id="qt_name" name="qt_name" v-model="formData.qt_name" readonly>
                        </div>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr v-for="(item, index) in qtList" :key="index">
                                    <td>
                                        <input type="text" class="form-control" name="q_name[]" readonly ="item.q_name">
                                    </td>
                                    <td>
                                        <input type="number" class="form-control" name="amount[]" readonly ="item.amount">
                                    </td>
                                    <td>
                                        <input type="text" class="form-control text-end" name="price[]" readonly ="item.price" @input="validatePrice(index)">
                                    </td>
                                    <td style="width: 20%;">
                    ...
                    <div class="d-flex justify-content-center">
                        <button type="button" class="btn btn-primary" @click="approveQt">ยืนยันใบเสนอราคา</button>
                        <button type="button" class="btn btn-secondary  mx-2">ยกเลิกใบเสนอราคา</button>
                    </div>
                </form>
            </div>
        </div>
...
export default {
    setup() {
        ...
        const approveQt = async () => {
            // id_customer.value

            try {
                const { data } = await axios.post(`${import.meta.env.VITE_API_URL}/qt/${id.value ? 'update_status/' + id.value : ''}`);
